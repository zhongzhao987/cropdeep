...
function AddChartData(key, title, lineData){
...
function InitializeChartTemperature(key, name, result, dataflag){
    ...
    AddChartData(key, name, lineData);
	
}

function InitializeChartNDVI(key, name, result, dataflag){
...
function InitializeChart(key, name, result, dataflag){
...
function setOwlSlideshow(result, dataflag) {
	...
	InitializeChartTemperature("chart-temperature", "Temperature Changes", result, dataflag);
	...
	InitializeChart("chart-precip", "Precipitation Changes", result, dataflag);
	...
	InitializeChart("chart-moisture", "Moisture Changes", result, dataflag);
	...
	InitializeChart("chart-neeco2", text, result, dataflag);
	...
	InitializeChartNDVI("chart-ndvi", "NDVI Changes", result, dataflag);
